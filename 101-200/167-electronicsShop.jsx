...
function getMoneySpent(keyboards, drives, b) {
  ...
  for (const keyboardPrice of keyboards) {
    // Iterate through each USB drive price
    for (const drivePrice of drives) {
      const total = keyboardPrice + drivePrice;
      // Check if the total cost is within the budget and is greater than the current maxSpent
